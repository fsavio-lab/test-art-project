...
// ── Shared easing (same as Contact page) ─────────────────────────────────────
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-7xl px-6 pb-20 pt-28">
        ...
        >
          <div>
            ...
            <p className="mt-6 font-body text-sm leading-relaxed text-muted-foreground">
              Founded in 2018 in Mumbai's historic Fort district, India Fine Art was born
              from a singular vision: to celebrate and preserve India's extraordinary
              artistic heritage through immersive technology.
            </p>

            <p className="mt-4 font-body text-sm leading-relaxed text-muted-foreground">
              Our mission is to bridge millennia of Indian artistic tradition with
              cutting-edge digital presentation, making the sublime craftsmanship of
              Madhubani, Tanjore, Pattachitra, Warli, and miniature painting accessible
              to a global audience of collectors and connoisseurs.
            </p>
          </div>
          ...
          <div className="overflow-hidden border border-border shadow-warm">
            <img
              src={artwork1}
              alt="India Fine Art Gallery interior"
        ...
        <section className="mt-24">
          <h2 className="mb-12 font-display text-3xl font-light text-foreground">
            Key Milestones
          </h2>
        ...
        <section className="mt-24 border-t border-border pt-16">
          <h2 className="mb-4 font-display text-3xl font-light text-foreground">
            Indian Art Forms We Celebrate
          </h2>

          <p className="mb-12 max-w-2xl font-body text-sm text-muted-foreground">
            A curated overview of the traditional art forms represented in our
            collection, each carrying centuries of cultural heritage.
          </p>
          ...
          >
            {artForms.map((form) => (
              <motion.div
                key={form.name}
                variants={staggerItem}
                className="border border-border bg-card p-6 shadow-warm transition-shadow duration-500 hover:shadow-warm-lg"
              >
                <h3 className="font-display text-xl font-light text-foreground">
                  {form.name}
                </h3>

                <p className="mt-1 font-body text-[10px] uppercase tracking-[0.2em] text-primary/70">
                  {form.origin} · {form.period}
                </p>
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <p className="font-body text-xs text-muted-foreground">
                    <span className="text-foreground/70">Symbolism:</span>{' '}
                    {form.symbolism}
                  </p>

                  <p className="mt-3 font-body text-xs italic leading-relaxed text-muted-foreground">
                    “{form.philosophy}”
                  </p>
                </div>
              </motion.div>
            ...
            {[
              {
                ...
                desc: 'We partner directly with master artisans and their families, ensuring traditional techniques survive for future generations.',
              },
              {
                title: 'Scholarly Curation',
                desc: 'Every exhibition is curated by art historians specializing in Indian art, ensuring cultural authenticity and scholarly depth.',
              },
              {
                title: 'Global Reach',
                desc: "With collectors in over 35 countries, we connect India's artistic legacy with discerning patrons worldwide.",
              },
            ].map((p) => (
        ...
        >
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 font-body text-sm leading-relaxed text-muted-foreground">
                Arjun Mehta is a visionary gallerist and art historian whose
                passion for Indian heritage has shaped India Fine Art into one
                of the country's most respected galleries for traditional and
                contemporary Indian art.
              </p>

              <blockquote className="mt-8 border-l-2 border-primary/30 pl-6 font-display text-lg italic text-foreground/80">
                “Every brushstroke carries a thousand years of heritage — our
                mission is to ensure those stories continue to be told.”
              </blockquote>
