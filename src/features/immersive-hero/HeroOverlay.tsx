...
import ArtCarousel from '../artwork-carousel/ArtCarousel';
const HeroOverlay = () => {
  return (
    <div>
      <section className="relative z-10 flex min-h-screen max-h-720px flex-col items-center justify-center px-6">
        <motion.div
